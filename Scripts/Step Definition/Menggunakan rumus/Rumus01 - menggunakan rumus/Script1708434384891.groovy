...
// Input nilai Penghasilan Total, Pengeluaran, dan Jangka Waktu
def penghasilanTotal = 100000000

def pengeluaran = 50000000

def jangkaWaktu = 1

// Hitung harga properti berdasarkan rumus
def hargaProperti = ((penghasilanTotal - pengeluaran) * jangkaWaktu) / 3
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Hitung Harga Properti Maksimal  BTN Properti  Indonesia/Verify/Page_Hitung Harga Properti Maksimal  BTN Properti  Indonesia/h3_Rp 200.000.000'), 
    'Rp 200.000.000')
